...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_M00_AXIS_AUD_NUM_CHANNELS"
...
proc update_PARAM_VALUE.C_M00_AXIS_AUD_NUM_CHANNELS { PARAM_VALUE.C_M00_AXIS_AUD_NUM_CHANNELS } {
	# Procedure called to update C_M00_AXIS_AUD_NUM_CHANNELS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M00_AXIS_AUD_NUM_CHANNELS { PARAM_VALUE.C_M00_AXIS_AUD_NUM_CHANNELS } {
	# Procedure called to validate C_M00_AXIS_AUD_NUM_CHANNELS
	return true
}
...
proc update_MODELPARAM_VALUE.C_M00_AXIS_AUD_NUM_CHANNELS { MODELPARAM_VALUE.C_M00_AXIS_AUD_NUM_CHANNELS PARAM_VALUE.C_M00_AXIS_AUD_NUM_CHANNELS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M00_AXIS_AUD_NUM_CHANNELS}] ${MODELPARAM_VALUE.C_M00_AXIS_AUD_NUM_CHANNELS}
}
