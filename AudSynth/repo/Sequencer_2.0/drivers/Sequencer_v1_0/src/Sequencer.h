...
#define SEQUENCER_S00_AXI_SLV_REG0_OFFSET 0
#define SEQUENCER_S00_AXI_SLV_REG1_OFFSET 4
#define SEQUENCER_S00_AXI_SLV_REG2_OFFSET 8
#define SEQUENCER_S00_AXI_SLV_REG3_OFFSET 12
 ...
 *
 * @param   baseaddr_p is the base address of the SEQUENCER instance to be worked on.
 *
 * @return
 *
