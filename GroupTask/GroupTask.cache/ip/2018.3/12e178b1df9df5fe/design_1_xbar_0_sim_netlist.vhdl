...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_19_addr_arbiter_sasd is
  port (
    ...
    \gen_arbiter.m_grant_hot_i[1]_i_7\ : in STD_LOGIC_VECTOR ( 3 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_19_addr_arbiter_sasd is
  ...
  attribute SOFT_HLUTNM of \gen_arbiter.m_grant_hot_i[1]_i_12\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \m_atarget_hot[10]_i_5\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \m_atarget_hot[10]_i_7\ : label is "soft_lutpair14";
...
\gen_arbiter.m_grant_hot_i[1]_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFDF"
        ...
        port map (
      I0 => \gen_arbiter.m_grant_hot_i[1]_i_7\(1),
      I1 => \gen_arbiter.m_grant_hot_i[1]_i_7\(0),
      I2 => \gen_arbiter.m_grant_hot_i[1]_i_7\(3),
      I3 => \gen_arbiter.m_grant_hot_i[1]_i_7\(2),
...
\gen_arbiter.m_grant_hot_i[1]_i_13\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000020"
        ...
        port map (
      I0 => m_axi_arready(1),
      I1 => \gen_arbiter.m_grant_hot_i[1]_i_7\(1),
      I2 => \gen_arbiter.m_grant_hot_i[1]_i_7\(0),
      I3 => \gen_arbiter.m_grant_hot_i[1]_i_7\(3),
      I4 => \gen_arbiter.m_grant_hot_i[1]_i_7\(2),
...
\gen_arbiter.m_grant_hot_i[1]_i_15\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000E00000002"
        ...
        port map (
      I0 => m_axi_arready(0),
      I1 => \gen_arbiter.m_grant_hot_i[1]_i_7\(3),
      I2 => \gen_arbiter.m_grant_hot_i[1]_i_7\(2),
      I3 => \gen_arbiter.m_grant_hot_i[1]_i_7\(1),
      I4 => \gen_arbiter.m_grant_hot_i[1]_i_7\(0),
      I5 => m_axi_arready(4),
...
\gen_arbiter.m_grant_hot_i[1]_i_17\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000020C00000200"
        ...
        port map (
      I0 => m_axi_arready(2),
      I1 => \gen_arbiter.m_grant_hot_i[1]_i_7\(2),
      I2 => \gen_arbiter.m_grant_hot_i[1]_i_7\(3),
      I3 => \gen_arbiter.m_grant_hot_i[1]_i_7\(1),
      I4 => \gen_arbiter.m_grant_hot_i[1]_i_7\(0),
      I5 => m_axi_arready(3),
...
\gen_arbiter.m_grant_hot_i[1]_i_18\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \gen_arbiter.m_grant_hot_i[1]_i_7\(0),
      I3 => \gen_arbiter.m_grant_hot_i[1]_i_7\(2),
      I4 => \gen_arbiter.m_grant_hot_i[1]_i_7\(3),
      I5 => m_axi_awready(5),
...
\gen_arbiter.m_grant_hot_i[1]_i_19\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => m_axi_awready(6),
      I1 => \gen_arbiter.m_grant_hot_i[1]_i_7\(0),
      I2 => \gen_arbiter.m_grant_hot_i[1]_i_7\(1),
      I3 => \gen_arbiter.m_grant_hot_i[1]_i_7\(2),
      I4 => \gen_arbiter.m_grant_hot_i[1]_i_7\(3),
      I5 => m_axi_awready(3),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_register_slice_v2_1_18_axic_register_slice is
  ...
  attribute SOFT_HLUTNM of \m_axi_rready[8]_INST_0\ : label is "soft_lutpair59";
  ...
  attribute SOFT_HLUTNM of \m_payload_i[34]_i_9\ : label is "soft_lutpair45";
  ...
  attribute SOFT_HLUTNM of \s_axi_bresp[0]_INST_0_i_1\ : label is "soft_lutpair49";
  attribute SOFT_HLUTNM of \s_axi_bresp[0]_INST_0_i_2\ : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of \s_axi_bresp[0]_INST_0_i_7\ : label is "soft_lutpair45";
...
addr_arbiter_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_19_addr_arbiter_sasd
     port map (
      ...
      \gen_arbiter.any_grant_reg_1\(0) => reg_slice_r_n_38,
      \gen_arbiter.m_grant_enc_i_reg[0]_0\ => addr_arbiter_inst_n_77,
      \gen_arbiter.m_grant_enc_i_reg[0]_1\ => addr_arbiter_inst_n_78,
      \gen_arbiter.m_grant_hot_i[1]_i_6\ => reg_slice_r_n_40,
      \gen_arbiter.m_grant_hot_i[1]_i_6_0\ => reg_slice_r_n_39,
      \gen_arbiter.m_grant_hot_i[1]_i_6_1\ => reg_slice_r_n_48,
      \gen_arbiter.m_grant_hot_i[1]_i_6_2\ => reg_slice_r_n_45,
      \gen_arbiter.m_grant_hot_i[1]_i_7\(3 downto 0) => m_atarget_enc(3 downto 0),
      ...
      \m_atarget_hot_reg[10]\ => addr_arbiter_inst_n_151,
      \m_atarget_hot_reg[10]_0\ => addr_arbiter_inst_n_152,
      ...
      m_axi_awready_0_sp_1 => addr_arbiter_inst_n_95,
      m_axi_awready_6_sp_1 => addr_arbiter_inst_n_97,
      ...
      \s_axi_bready[0]_0\ => addr_arbiter_inst_n_55,
      ...
      s_ready_i_reg_2(0) => reg_slice_r_n_62,
      sr_rvalid => sr_rvalid
    );
...
\gen_decerr.decerr_slave_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_19_decerr_slave
     port map (
      ...
      \gen_arbiter.m_grant_hot_i[1]_i_3_0\ => addr_arbiter_inst_n_100,
      \gen_arbiter.m_grant_hot_i[1]_i_3_1\ => splitter_ar_n_4,
      \gen_arbiter.m_grant_hot_i[1]_i_3_2\ => addr_arbiter_inst_n_96,
      \gen_arbiter.m_grant_hot_i_reg[1]\ => addr_arbiter_inst_n_55,
      \gen_arbiter.m_grant_hot_i_reg[1]_0\ => addr_arbiter_inst_n_78,
...
reg_slice_r: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_register_slice_v2_1_18_axic_register_slice
     port map (
      ...
      aa_rready => aa_rready,
      aclk => aclk,
      \aresetn_d_reg[0]_0\(0) => reg_slice_r_n_62,
...
splitter_ar: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_19_splitter__parameterized0\
     port map (
      ...
      aclk => aclk,
      aresetn_d => aresetn_d,
      \gen_arbiter.m_grant_hot_i[1]_i_3\ => reg_slice_r_n_46,
...
splitter_aw: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_19_splitter
     port map (
      ...
      \gen_arbiter.m_grant_hot_i[1]_i_6_1\ => reg_slice_r_n_47,
      ...
      \m_ready_d_reg[2]_3\ => addr_arbiter_inst_n_98,
      \m_ready_d_reg[2]_4\ => addr_arbiter_inst_n_77,
      \m_ready_d_reg[2]_5\ => addr_arbiter_inst_n_54,
      mi_wready(0) => mi_wready(10)
    );
end STRUCTURE;
library IEEE;
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_19_axi_crossbar is
  ...
  attribute C_M_AXI_BASE_ADDR of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_19_axi_crossbar : entity is "640'";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute C_M_AXI_BASE_ADDR : string;
  attribute C_M_AXI_BASE_ADDR of inst : label is "640'";
  attribute C_M_AXI_READ_CONNECTIVITY : string;
