...
proc create_root_design { parentCell } {
  ...
  # Create instance: slot_0_apc, and set properties
  set slot_0_apc [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_protocol_checker:2.0 slot_0_apc ]
  set_property -dict [ list \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets Conn] [get_bd_intf_ports SLOT_0_AXI] [get_bd_intf_pins slot_0_apc/PC_AXI]

  # Create port connections
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins g_inst/aclk] [get_bd_pins ila_lib/clk] [get_bd_pins slot_0_apc/aclk]
  connect_bd_net -net net_slot_0_apc_pc_asserted [get_bd_pins ila_lib/probe18] [get_bd_pins slot_0_apc/pc_asserted]
  ...
  connect_bd_net -net resetn_1 [get_bd_ports resetn] [get_bd_pins g_inst/aresetn] [get_bd_pins slot_0_apc/aresetn]
